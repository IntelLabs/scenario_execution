            ...
            IncludeLaunchDescription(
                ...
                launch_arguments={'headless': 'False',
                                  ...
                                  'scenario': os.path.join(scenario_execution_gazebo_dir,
                                                           'scenarios', 'test_spawn_xacro_with_parameters.osc')}.items()),
        ]),
        {}
    )
...
class TestProcessOutput(unittest.TestCase):
    ...
    def test_output(self, proc_output, proc_info):
        ...
        proc_output.assertWaitFor(
            "Executing scenario 'test_spawn_xacro_with_parameters'", timeout=120)
        ...
        proc_output.assertWaitFor(
            "Scenario 'test_spawn_xacro_with_parameters' succeeded.", timeout=120)
