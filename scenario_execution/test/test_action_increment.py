...
"""
    ...
    def test_success_direct_var_init(self):
        scenario_content = """
import osc.helpers
...
"""
    ...
    def test_success_direct_var_uninitialized(self):
        scenario_content = """
import osc.helpers
...
scenario test:
    ...
    my_actor: test_actor
    do serial:
        increment(my_actor.my_var)
"""
        self.assertRaises(ActionError, self.execute, scenario_content)
        self.assertFalse(self.scenario_execution.process_results())

    def test_success_actor_var_init(self):
        scenario_content = """
import osc.helpers
...
"""
    ...
    def test_success_var_in_actor_param(self):
        scenario_content = """
import osc.helpers

struct test_stru:
    var my_sub_var: int = 22
...
scenario test_scenario:
    ...
    my_actor: test_actor
    do serial:
        increment(my_actor.my_struct.my_sub_var)
        wait my_actor.my_struct.my_sub_var == 23
"""
        self.execute(scenario_content)
        self.assertTrue(self.scenario_execution.process_results())

    def test_fail_var_in_actor_param(self):
        scenario_content = """
import osc.helpers
